        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav">
                     <!--<li class="current">-->    
                   <li>             	
                        <a href="javascript:addTab('纳税人管理','manage/jsp/listTaxPayer.jsp')">
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','SearchTaskServlet.do')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','toAddTaskServlet.do')">调查任务录入</a></li>
                            <li><a href="javascript:addTab('未调查企业统计','manage/jsp/statistical.jsp')">未被调查企业统计</a></li>
                        </ul>
                     </li>                    
                     <li>             	
                        <a href="javascript:addTab('办税专员管理','manage/jsp/listTaxer.jsp');">
                            <span class="iconfont sider-nav-icon">&#xe620;</span>
        ...
        $(function(){
        	...
        	$(".userInfo").on("click",function(){
        			$("#topWindow").window({
        				...
        				width:800,
        				height:300,
        				content:"<iframe scrolling='no' width='100%' height='100%' src='manage/jsp/userInfo.jsp'></iframe>"
        			})
        	})
        	...
        	$(".modify_pwd").on("click",function(){
        		$("#topWindow").window({
        				...
        				width:400,
        				height:300,
        				content:"<iframe scrolling='no' width='100%' height='100%' src='manage/jsp/modifypassword.jsp'></iframe>"
        			})
        	})
