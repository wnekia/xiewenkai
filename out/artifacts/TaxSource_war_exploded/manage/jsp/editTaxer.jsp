     ...
     <div class="container">
        <div class="content">
            <div title="办税专员信息" data-options="closable:false" class="basic-info">
                ...
                <form id="editForm">
                <input name="sid" id="id" type="hidden" value="${requestScope.taxer.id }">
                <table class="kv-table">              	
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td class="kv-content">
                        	<input type="radio" name="sex" class="easyui-validatebox" data-options="required:true" placeholder="男" ${"男" == requestScope.taxer.sex ? "checked":""} value="1"> 男
                        	<input type="radio" name="sex" class="easyui-validatebox" data-options="required:true" placeholder="女" ${"女" == requestScope.taxer.sex ? "checked":""} value="0"> 女
                        	</td>
                    ...
                    <td class="kv-label">Email</td>
                        ...
                        <td class="kv-content">
                            ...
                            <c:forEach items="${requestScope.organs }" var="organ">
                            	<option value="${organ.id }" ${organ.id == requestScope.taxer.organId ? "selected":""}>${organ.organName }</option>
                            </c:forEach>                                             
                            </select>
                        </td>
                    </tr>                     
